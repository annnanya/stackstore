...
import ManyOnBook from "/ManyOnBook.png"
const Banner = () => {
    return (
        <>
            <div className=" max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10 dark:bg-slate-900 dark:text-white">
                <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-36">
                    <div className="space-y-8">
                        ...
                        <p className="text-sm md:text-base">
                            ...
                            Whether you're after bestsellers or hidden gems, we've got something for every reader.
                            Dive in and find your next great read!
                        </p>
                ...
                <div className=" order-1 w-full mt-20 md:w-1/2">
                    <img
                        src={ManyOnBook}
                        className="md:w-[590px] md:h-[470px] md:ml-12"
                        alt=""
                    />
                </div>
            </div>
